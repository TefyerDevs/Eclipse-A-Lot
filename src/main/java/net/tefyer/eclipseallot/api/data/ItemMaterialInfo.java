...
public class ItemMaterialInfo {
    ...
    private void setSortedMaterials(Reference2LongMap<Material> matStacks) {
        ...
        for (var matStack : sortedMaterials) {
            ret.append(matStack.amount() / (float) APIUtils.Number.M).append("x ")
                    .append(matStack.material().getProperties().getResourceLocation()).append(" ");
        }
        ret.append("]");
